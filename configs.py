...
def add_args(parser):
    ...
    parser.add_argument("--few_shot", action="store_true", help="Few shot learning or not.")
    parser.add_argument("--soft_prompt", action="store_true", help="Soft Prompt template or not.")
    parser.add_argument("--expert_knowledge", action="store_true", help="Use expert knowledge or not.")

    ## Other parameters
    parser.add_argument("--train_filename", default="", type=str,
                        help="The train filename. Should contain the .jsonl files for this task.")
    parser.add_argument("--valid_filename", default="", type=str,
                        help="The valid filename. Should contain the .jsonl files for this task.")
    ...
    parser.add_argument("--label_category", default=2, type=int,
                        help="Number of label categories.")
